...
* @class Expr_Builder
*
* Implementation of expression builder
*/
class Expr_Builder
{
public:
	...
	* @return						the expression tree
	*/
	virtual Expr_Node * getExpression(void) = 0;

protected:
	// Stack to store expression nodes
	std::stack<Expr_Node*> expr_stack;
	// Stack to store operation nodes
	std::stack<Expr_Node*> op_stack;
};
